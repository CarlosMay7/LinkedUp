        ...
        <div className="users-table">
          ...
          <div className="table-row">
            ...
            <div className="col-acciones">
                {/* <span className="advertido">Advertir</span> */}
              <button 
          ...
          <div className="table-row">
            ...
            <div className="col-acciones">
              ...
              {/* <button 
                className={`action-btn btn-bloquear ${manualActions.Usuario_Z === 'bloquear' ? 'active' : ''}`}
                onClick={() => handleManualAction('Usuario_Z', 'bloquear')}
              >
                Bloquear
              </button> */}
            </div>
...
//     <div className="admin-page">
//       <div className="admin-header">
//         <h1>Estadísticas Globales de Moderación</h1>
//       </div>
...
//               <div className="filtered-today">
//                 <span className="label">Filtradas (Hoy)</span>
//                 <span className="value">11,204</span>
//               </div>
//             </div>
...
//                 <div className="word-item">
//                   <span className="rank">1.</span>
//                   <span className="word">Palabra_A</span>
...
//       <div className="users-section">
//         <h2>Gestión Manual de Usuarios (RF-010)</h2>
//         <div className="users-table">
//           <div className="table-header">
//             <div className="col-usuario">Usuario</div>
//             <div className="col-mensajes">Mensajes Obscenos</div>
...
//             <div className="col-acciones">
//               <button 
//                 className={`btn-advertir ${manualActions.Usuario_X === 'advertir' ? 'active' : ''}`}
//                 onClick={() => handleManualAction('Usuario_X', 'advertir')}
//               >
//                 Advertir
//               </button>
//               <button 
//                 className={`btn-bloquear ${manualActions.Usuario_X === 'bloquear' ? 'active' : ''}`}
//                 onClick={() => handleManualAction('Usuario_X', 'bloquear')}
//               >
//                 Bloquear
//               </button>
...
//           <div className="table-row">
//             <div className="col-usuario">Usuario_Y</div>
//             <div className="col-mensajes">8</div>
//             <div className="col-acciones">
//               <span className="advertido">Advertir</span>
//               <button 
//                 className={`btn-bloquear ${manualActions.Usuario_Y === 'bloquear' ? 'active' : ''}`}
//                 onClick={() => handleManualAction('Usuario_Y', 'bloquear')}
//               >
//                 Bloquear
//               </button>
...
//           <div className="table-row">
//             <div className="col-usuario">Usuario_Z</div>
//             <div className="col-mensajes">3</div>
//             <div className="col-acciones">
//               <span className="bloqueado">Bloqueado</span>
//               <button 
//                 className={`btn-bloquear ${manualActions.Usuario_Z === 'bloquear' ? 'active' : ''}`}
//                 onClick={() => handleManualAction('Usuario_Z', 'bloquear')}
//               >
//                 Bloquear
//               </button>
...
//           <div className="table-row">
//             <div className="col-usuario">Usuario_A</div>
//             <div className="col-mensajes">0</div>
//             <div className="col-acciones">
//             </div>
//           </div>
//         </div>
...
//       <div className="auto-actions-section">
//         <h3>Acciones Automáticas (RF-010)</h3>
//         <div className="auto-block">
//           <p>
//             Bloquear cuenta automáticamente al superar 
//             <input 
...
//       <div className="save-section">
//         <button className="btn-save" onClick={handleSaveActions}>
//           GUARDAR ACCIONES
//         </button>
//       </div>
//     </div>
